...
Не используй окружения LaTeX tikzpicture и center. Если в исходнике есть рисунок, не вставляй его код как текст.
Используй настоящие HTML-теги без пробелов: <br>, а не < br >. Не добавляй amp; перед пунктами списка.
Обычный текст и математические формулы не оборачивай в <code>; этот тег используй только для программного кода.
